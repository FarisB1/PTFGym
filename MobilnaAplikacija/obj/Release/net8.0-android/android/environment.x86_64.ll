...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Microsoft.Extensions.Http.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1045273134449459286, ; hash 0xe818e60b01e8056, from name: aot-MobilnaAplikacija
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 29
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2442507803615819416, ; hash 0x21e587e80ba3f698, from name: libaot-MobilnaAplikacija
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Microsoft.Extensions.Diagnostics.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6265612516895928319, ; hash 0x56f3ed6331d2afff, from name: MobilnaAplikacija
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		i64 6905809894123079159, ; hash 0x5fd65d82999585f7, from name: MobilnaAplikacija.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 187
	...
	%struct.DSOCacheEntry {
		i64 7518916353680346225, ; hash 0x68588e9634fe0c71, from name: libaot-MobilnaAplikacija.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	...
	%struct.DSOCacheEntry {
		i64 10199430204611170639, ; hash 0x8d8ba7bb713d114f, from name: aot-MobilnaAplikacija.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 305
...
@.env.3 = private unnamed_addr constant [37 x i8] c"b1b079f7-15c3-4a72-bb29-cac03dec4b31\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.mobilnaaplikacija\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-MobilnaAplikacija.dll.so\00", align 16
...
@.DSOCacheEntry.13_name = private unnamed_addr constant [47 x i8] c"libaot-Microsoft.Extensions.Diagnostics.dll.so\00", align 16
...
@.DSOCacheEntry.15_name = private unnamed_addr constant [40 x i8] c"libaot-Microsoft.Extensions.Http.dll.so\00", align 16
