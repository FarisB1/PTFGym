...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 923322788, ; hash 0x3708c9a4, from name: MobilnaAplikacija.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1266237914, ; hash 0x4b7941da, from name: aot-MobilnaAplikacija
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	...
	%struct.DSOCacheEntry {
		i64 1924095012, ; hash 0x72af5c24, from name: MobilnaAplikacija
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 240
	...
	%struct.DSOCacheEntry {
		i64 2857848051, ; hash 0xaa574cf3, from name: aot-MobilnaAplikacija.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 3311076677, ; hash 0xc55b0545, from name: libaot-MobilnaAplikacija
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 449
	...
	%struct.DSOCacheEntry {
		i64 3345832311, ; hash 0xc76d5977, from name: libaot-MobilnaAplikacija.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MobilnaAplikacija.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
