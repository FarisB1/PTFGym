...
namespace PTFGym.Data.Migrations
{
    ...
    [Migration("20250101210333_UpdateKoZnaKoji2")]
    partial class UpdateKoZnaKoji2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTFGym.Models.TerminClan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PTFGym.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("PTFGym.Models.ApplicationUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
