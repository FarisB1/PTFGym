...
namespace PTFGym.Data.Migrations
{
    ...
    [Migration("20250209005615_AddRating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClanTermin", b =>
                {
                    ...
                    b.HasKey("ClanoviId", "TerminiId");

                    b.HasIndex("TerminiId");

                    b.ToTable("TerminClan", (string)null);
                });
            ...
            modelBuilder.Entity("PTFGym.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PTFGym.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClanTermin", b =>
                {
                    b.HasOne("PTFGym.Models.Clan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PTFGym.Models.ApplicationUser", null)
                        .WithMany()
